  ...
  <div class="container-fluid main">
    ...
    <div class="row">
      ...
      <div class="col-12 row filtros">
        ...
        <div class="col-12 col-lg-6">
          <label for="cuenta" class="form-label">A nombre de:</label>
        ...
        <div class="col-6 row centrar p-4">
          <button id="btnExportExcel" type="button"
            class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-500 w-full md:w-2/4">
      ...
      <div class="row respuesta" id="respuesta">
        ...
        <div class="col-12 col-lg-6 d-flex justify-content-center">
          <div class="noc-card noc-card--noc1 w-100">
            ...
            <div class="datos">
              ...
              <div class="noc-col">
                ...
                <div class="noc-subdivider"></div>

                <div class="col-12 label-e centrar">
                  <span>Ingreso banco</span>
                </div>
                <div class="col-12 monto-e centrar">
                  <span id="ingreso-banco-noc1"></span>
                </div>
                ...
                <div class="col-12 monto-e centrar">
                  <span class="text-danger" id="gasto-banco-noc1"></span>
                </div>
            ...
            <div class="col-12 centrar txt-ganancias">
              <span class="text-success">Total de Ganancias</span>
            </div>
            ...
            <div class="col-12 row">
              ...
              <div class="col-12 centrar txt-ganancias">
                <span class="text-success">Total a Entregar</span>
              </div>
              <div class="col-12 centrar total-ganancias">
        ...
        <!-- NOC2 -->
        <div class="col-12 col-lg-6 d-flex justify-content-center">
          <div class="noc-card noc-card--noc2 w-100">
            ...
            <div class="datos">
              <div class="col-12">
                ...
                <div class="col-12 monto-e-bbs centrar">
                  <span id="ingreso-banco-noc2"></span>
                </div>
                ...
                <div class="col-12 monto-e-bbs centrar">
                  <span class="text-danger" id="gasto-banco-noc2"></span>
                </div>
